...
static void maynard_launcher_init(MaynardLauncher *self)
{
...
static gint sort_apps(gconstpointer a, gconstpointer b)
{
...
static gboolean
get_child_position_cb(GtkOverlay *overlay, GtkWidget *widget, GdkRectangle *allocation, gpointer user_data)
{
...
static gboolean app_launched_idle_cb(gpointer data)
{
...
static void clicked_cb(GtkWidget *widget, GDesktopAppInfo *info)
{
...
static gboolean
app_enter_cb(GtkWidget *widget, GdkEvent *event, GtkWidget *revealer)
{
...
static gboolean
app_leave_cb(GtkWidget *widget, GdkEvent *event, GtkWidget *revealer)
{
...
static GtkWidget *app_launcher_new_from_desktop_info(MaynardLauncher *self, GDesktopAppInfo *info)
{
	...
	gtk_style_context_add_class(gtk_widget_get_style_context(ebox), "maynard-grid-item");
	...
	g_object_set(image, "margin", 30, NULL);
...
static void
background_size_allocate_cb(GtkWidget *widget, GdkRectangle *allocation, MaynardLauncher *self)
{
	installed_changed_cb(self->priv->app_system, self);
}

static void maynard_launcher_constructed(GObject *object)
{
...
static void
maynard_launcher_get_property(GObject *object, guint param_id, GValue *value, GParamSpec *pspec)
{
	MaynardLauncher *self = MAYNARD_LAUNCHER(object);
...
static void
maynard_launcher_set_property(GObject *object, guint param_id, const GValue *value, GParamSpec *pspec)
{
	MaynardLauncher *self = MAYNARD_LAUNCHER(object);
...
static void maynard_launcher_class_init(MaynardLauncherClass *klass)
{
...
{
	return g_object_new(MAYNARD_LAUNCHER_TYPE, "background", background_widget, NULL);
}
                           ...
                           gint *grid_cols)
{
	...
	gtk_widget_get_size_request(self->priv->background, &output_width, &output_height);
